...
public class SearchByPhoneNo implements Search{

public static void search(List<Contacts> contacts,String phoneNo) {		
	
		System.out.println("");
		System.out.println("Search Result - ");
		int count = 1;
		for(Contacts contact : contacts) {
			if(contact.getPhoneNo().equalsIgnoreCase(phoneNo)) {
